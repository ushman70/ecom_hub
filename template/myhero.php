...
<div id="ModalExample" class="modal fade">
 ...
 $time3 = date('Y/m/d');
      $i = 0;
      foreach($product->myherofigures('product') as $item){
        $i++;
          
        
    
      ?>
       <?php $sqlr = $conn->query("SELECT * FROM rate WHERE keyword='myhero$i'");
      $numR = $sqlr->num_rows;
      $sqlr = $conn->query("SELECT SUM(userReview) AS total FROM rate WHERE keyword='myhero$i'");
      ...
      <div class="col-md-3 col-sm-6 my-3 my-md-0">
       <form method="post">
         <div class="card shadow bg-white mb-3">
           <div>
           <?php echo "<a href=\"myhero" . $i . ".php\">" ?><img src="<?php echo $item['item_image'] ?? "./UI-goku.jpg" ?>" alt="Image1" class="img-fluid card-img-top"><?php echo "</a>" ?>
           </div>
