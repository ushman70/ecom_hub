...
<div id="ModalExample" class="modal fade">
 ...
 <a href="../index.php"><h1 class="logo">Ecomhub</h1></a>
    ...
    <?php foreach($product->getCorsair('product') as $item){?>
...
<ul class="mr-5 d-flex" style="List-style-type: none;">
  ...
  <div class="row">
    ...
    <div class="bg-light" style="height: 75%;"><img src="<?php echo $item['item_image']?>" width="200px"/>
...
<div class="container d-flex justify-content-center">
  <div class="row bg-dark text-light w-50" style="font-family: 'Ubuntu', sans-serif"> 
  2021 Newest PlayStation: Experience lightning fast loading with an ultra-high speed SSD, <br>deeper immersion with support for haptic feedback,<br> adaptive triggers and 3D Audio, and an all-new generation of incredible PlayStation games
Ultra-high speed SSD: Maximize your play sessions with near-instant load times for installed PS5 games
Up to 120 fps with 120Hz output: Enjoy smooth and fluid high frame rate gameplay at up to 120<br> fps for compatible games, with support for 120Hz output on 4K displays
Bundle with PlayStation VR headset, adapter, camera, two Move Controllers, earbuds, processor<br> unit, Iron Man VR full game and demo games </div>
</div>
