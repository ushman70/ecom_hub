...
<div id="ModalExample" class="modal fade">
 ...
 $time3 = date('Y/m/d');
      ...
      foreach($product->gundamkits('product') as $item){
      ...
      ?>
      <?php $sqlr = $conn->query("SELECT * FROM rate WHERE keyword='gundam$i'");
      $numR = $sqlr->num_rows;
      $sqlr = $conn->query("SELECT SUM(userReview) AS total FROM rate WHERE keyword='gundam$i'");
      ...
      <div class="col-md-3 col-sm-6 my-3 my-md-0">
        <form method="post">
         <div class="card shadow bg-white mb-3">
           <div>
           <?php echo "<a href=\"gundam" . $i . ".php\">" ?><img src="<?php echo $item['item_image'] ?? "./UI-goku.jpg" ?>" alt="Image1" class="img-fluid card-img-top"><?php echo "</a>" ?>
           </div>
            ...
            <div class="pro-rating">
              <div class="clearfix rating marT8 ">
                <div class="rating-stars">
                  <div class="grey-stars text-white" style="position:relative;left:4px;font-family: 'Roboto', sans-serif;"><a class="text-dark">(<?php print $numR?>)</a></div>
