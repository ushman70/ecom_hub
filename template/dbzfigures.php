...
<div id="ModalExample" class="modal fade">
 ...
 <h1 class="logo" href="index.php">Ecomhub</h1>
 ...
 $time3 = date('Y/m/d');
      $i = 0;
      foreach($product->dbzfigures('product') as $item){
        $i++;
          
        
    
      ?>
       <?php $sqlr = $conn->query("SELECT * FROM rate WHERE keyword='dbz$i' ");
      $numR = $sqlr->num_rows;
      $sqlr = $conn->query("SELECT SUM(userReview) AS total FROM rate WHERE keyword='dbz$i'");
      ...
      <div class="col-md-3 col-sm-6 my-3 my-md-0">
       <form method="post">
         <div class="card shadow bg-light mb-3">
           <div>
           <?php echo "<a href=\"dbz" . $i . ".php\">" ?><img src="<?php echo $item['item_image'] ?? "./UI-goku.jpg" ?>" alt="Image1" class="img-fluid card-img-top"><?php echo "</a>" ?>
           </div>
            ...
            <div class="pro-rating">
              <div class="clearfix rating marT8 ">
                <div class="rating-stars">
                  <div class="grey-stars text-white" style="position:relative;left:4px;"><a class="text-dark">&nbsp;&nbsp;&nbsp;&nbsp;(<?php print $numR?>)</a></div>
                    <div class="filled-stars text-dark" style="width:<?php echo $avg * 20 -10  ?>%"></div>
                </div>
              </div>
            </div>
          </div>
