...
<div id="ModalExample" class="modal fade">
 ...
 <a href="../index.php"><h1 class="logo">Ecomhub</h1></a>
    ...
    <?php foreach($product->getshirt1('product') as $item){?>
...
<ul class="mr-5 d-flex" style="List-style-type: none;">
  ...
  <div class="row">
    ...
    <div class="bg-light" style="height: 0%;"><img src="<?php echo $item['item_image']?>" height="250px" width="250px"/>
  ...
  <form class="row bg-light border border-dark text-center" style="height: 75%; position: relative; left: 50px;" method="post">
    <div class="text-danger" style="font-size: 25px; font-family: 'Roboto', sans-serif;">
      ...
      <li>
        ...
        <li><input type="hidden" name="item_id" value="<?php echo $item["item_id"]; ?>">
            ...
            <select required name="size" name="size" id="size">
                <option value=""></option>
...
<div class="container d-flex justify-content-center">
  <div class="row bg-dark text-light mr-5" style="font-family: 'Ubuntu', sans-serif">The real grade mobile suit developed by 
