...
<div id="ModalExample" class="modal fade">
 ...
 <a href="../index.php"><h1 class="logo">Ecomhub</h1></a>
    ...
    <?php foreach($product->getposter7('product') as $item){?>
...
<ul class="mr-5 d-flex" style="List-style-type: none;">
  ...
  <form class="row bg-light border border-dark text-center ml-5" style="height: 25%;position:relative;right:25px;" method="post">
...
<div class="container d-flex justify-content-center ml-3">
