...
<div id="ModalExample" class="modal fade">
 ...
 <a href="../index.php"><h1 class="logo">Ecomhub</h1></a>
    ...
    <?php foreach($product->getRGgundam('product') as $item){?>
...
<ul class="mr-5 d-flex" style="List-style-type: none;">
  ...
  <div class="row">
    ...
    <div class="bg-light border border-dark" style="height: 100%;"><img src="<?php echo $item['item_image']?>"/>
...
<div class="review-modal" style="display:none">
                ...
                <div class="uscm">
                    <?php
                     require ('../quickdb.php');
                        $sqlp = "SELECT * FROM rate WHERE keyword='gundam1'";
