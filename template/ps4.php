...
<div id="ModalExample" class="modal fade">
 ...
 <a href="../index.php"><h1 class="logo">Ecomhub</h1></a>
    ...
    <?php foreach($product->getPS4('product') as $item){?>
...
<ul class="mr-5 d-flex" style="List-style-type: none;">
  <li><img class="enlarge mr-1 border border-warning" src="<?php echo $item['item_image']?>1.jpg" width="150px" height="150px"/></li>
  <li><img class="enlarge border border-warning" src="<?php echo $item['item_image']?>2.jpg" width="150px" height="150px"/></li>
</ul>
<ul class="mr-5 d-flex" style="List-style-type: none;">
  <li><img class="enlarge mr-1 border border-warning" src="<?php echo $item['item_image']?>3.jpg" width="150px" height="150px"/></li>
  <li><img class="enlarge border border-warning" src="<?php echo $item['item_image']?>4.png" width="150px" height="150px"/></li>
</ul>
  </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="bg-light" style="height: 75%;"><img src="<?php echo $item['item_image']?>.png"/>
...
<div class="container d-flex justify-content-center">
  <div class="row bg-dark text-light" style="font-family: 'Ubuntu', sans-serif"> 
  2021 Newest PlayStation: Experience lightning fast loading with an ultra-high speed SSD, deeper immersion with support for haptic feedback, adaptive triggers and 3D Audio, and an all-new generation of incredible PlayStation games
...
Bundle with PlayStation VR headset, adapter, camera, two Move Controllers, earbuds, processor unit, Iron Man VR full game and demo games </div>
</div>
