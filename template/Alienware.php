...
<div id="ModalExample" class="modal fade">
 ...
 <a href="../index.php"><h1 class="logo">Ecomhub</h1></a>
    ...
    <?php foreach($product->getAlienware('product') as $item){?>
...
<ul class="mr-5 d-flex" style="List-style-type: none;">
  ...
  <div class="row">
    ...
    <ul class="border border-dark w-100 text-center mr-5" style="List-style-type: none;position:relative;right:30px;">
      <br>
