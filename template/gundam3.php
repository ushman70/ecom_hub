...
<div id="ModalExample" class="modal fade">
 ...
 <a href="../index.php"><h1 class="logo">Ecomhub</h1></a>
    ...
    <?php foreach($product->getgundam3('product') as $item){?>
...
<ul class="mr-5 d-flex" style="List-style-type: none;">
  ...
  <li><img class="enlarge border border-warning" src="<?php echo $item['item_image']?>4.webp" width="150px" height="150px"/></li>
</ul>
  </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="bg-light" style="height: 75%;"><img src="<?php echo $item['item_image']?>.jpg"/>
    ...
    <div class="text-danger" style="font-size: 25px; font-family: 'Roboto', sans-serif;">
      ...
      <li>
        ...
        <li><input type="hidden" name="item_id" value="<?php echo $item["item_id"]; ?>">
            ...
            <input type="hidden" name="image" value="<?php echo $item['item_image']?>.jpg">
